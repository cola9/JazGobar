...
public class ActivitySporneSlikeGob extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String IMAGES_URL = "https://jazgobar.000webhostapp.com/AndroidUploadImage/getAllImagesModerator.php";
    private static final String oceniSliko_URL = "https://jazgobar.000webhostapp.com/AndroidUploadImage/oceniSlikoModerator.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sporne_slike_gob);
    ...
    private void getAllImages() {
        class GetAllImages extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ActivitySporneSlikeGob.this, "Fetching Data...","Please Wait...",true,true);
            }
    ...
    private void getImage(String urlToImage){
        class GetImage extends AsyncTask<String,Void,Bitmap>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ActivitySporneSlikeGob.this,"Downloading Image...","Please wait...",true,true);
            }
    ...
    private void oceniSliko(String url, String ocena){
        class GetImage extends AsyncTask<String,Void,String>{
            ...
            protected String doInBackground(String... params) {
                ...
                BufferedReader bufferedReader = null;
                String urlTouriImage = params[0];
                String ocena = params[1];
                String uri = params[0];
                try {
                    URL url = new URL(uri);
                    HttpURLConnection con = (HttpURLConnection) url.openConnection();
                    ...
                    JSONObject postDataParams = new JSONObject();
                    postDataParams.put("username", username);
                    postDataParams.put("id", slika_id);
                    postDataParams.put("ocena", ocena);
                    con.setReadTimeout(15000 /* milliseconds */);
                    con.setConnectTimeout(15000 /* milliseconds */);
                    con.setRequestMethod("POST");
                    con.setDoInput(true);
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ActivitySporneSlikeGob.this,"Ocenjujem...","Please wait...",true,true);
            }

            @Override
            protected void onPostExecute(String ocena) {
                super.onPostExecute(ocena);
                loading.dismiss();
                //imageView.setImageBitmap(bitmap);
            }
        }
        GetImage gi = new GetImage();
        gi.execute(url,ocena);
    }
}
