...
public class ActivitySlikeGob extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String IMAGES_URL = "https://jazgobar.000webhostapp.com/AndroidUploadImage/getAllImages.php";
    private static final String oceniSliko_URL = "https://jazgobar.000webhostapp.com/AndroidUploadImage/oceniSliko.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slike_gob);
    ...
    private void getAllImages() {
        class GetAllImages extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ActivitySlikeGob.this, "Fetching Data...","Please Wait...",true,true);
            }
    ...
    private void getImage(String urlToImage){
        class GetImage extends AsyncTask<String,Void,Bitmap>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ActivitySlikeGob.this,"Downloading Image...","Please wait...",true,true);
            }
    ...
    private void oceniSliko(String url, String ocena){
        class GetImage extends AsyncTask<String,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ActivitySlikeGob.this,"Ocenjujem...","Please wait...",true,true);
            }
